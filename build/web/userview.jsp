...
<%
      try {
        ...
        String sql = "select a.iid,c.iname,b.bid,bname,itype,idate,itime,seats from ibranch a,bnames b,inames c where a.bid=b.bid and c.iid=a.iid";
...
<TABLE cellpadding="15" border="1" style="background-color: #ffffcc;" align="center">
    ...
    <font size="+3" color="red"></b>
        ...
        <TR>
            <TD><FORM ACTION="ireg.jsp" method="get" >
